# dokku memcached [![Build Status](https://img.shields.io/github/workflow/status/dokku/dokku-memcached/CI/master?style=flat-square "Build Status")](https://github.com/dokku/dokku-memcached/actions/workflows/ci.yml?query=branch%3Amaster) [![IRC Network](https://img.shields.io/badge/irc-libera-blue.svg?style=flat-square "IRC Libera")](https://webchat.libera.chat/?channels=dokku)

Official memcached plugin for dokku. Currently defaults to installing [memcached 1.6.17](https://hub.docker.com/_/memcached/).
